...
# CONFIGURAMOS VARIABLE DE ENTORNO PARA QUE LA APP REST DJANGO PERMITA JWT
...
# CONFIGURAMOS JWT CARACTERÍSTICAS
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True,  # Opcional: genera un nuevo refresh token al hacer refresh
    'BLACKLIST_AFTER_ROTATION': True,  # Opcional: invalida refresh tokens antiguos
